          ...
          <div className="md:flex md:items-center md:justify-between">
            <div className="md:w-2/3">
              <p className="mt-4 p-5 block font-sans text-base antialiased font-light leading-relaxed text-inherit">
                Hello, I am Guido Asbun, and welcome to my portfolio page. I am
                a Junior at the California State University Fullerton&apos;s
                Computer Science Program. I have a passion for technologies and
                problem solving. Through my Computer Science journey I was able
                to intern at two companies, Snap Chat, and Axios media. And I
                built multiple projects that show my passion for technology and
                problem solving. In my website, you will be able to know all
                about me in a simple to navigate and visually appealing way.
              </p>
              <div className="mt-6">
                <ActionButton
                  title={"GitHub"}
